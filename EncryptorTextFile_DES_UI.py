...
class CryptoApp:
    ...
    def decrypt_file(self):
        ...
        if plaintext != b"":  # Check if decryption is successful
            messagebox.showinfo("Decryption Error", "Decryption failed. The provided key may not match the encryption key.")
        else:
